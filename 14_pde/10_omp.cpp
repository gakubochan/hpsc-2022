...
int main(){
	...
	/*
	vector<vector<float> > u(ny, vector<float>(nx, 0));
	vector<vector<float> > v(ny, vector<float>(nx, 0));  
	vector<vector<float> > p(ny, vector<float>(nx, 0));   
	vector<vector<float> > b(ny, vector<float>(nx, 0));
